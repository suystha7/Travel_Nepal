...
const PackageHighlights = ({ highlights, imageGallery }: IProps) => {
  ...
  const totalSlides = Math.min(highlights.length, 5, imageGallery.length, 5);
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-stretch gap-16">
          ...
          <div className="lg:w-[45%] relative aspect-video group">
            <div className="absolute inset-0 border-10 border-gray-100 translate-x-6 translate-y-6 z-0 rounded-4xl" />
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      fill
                      className="object-cover transition-transform duration-2000 hover:scale-105 shadow-2xl"
                      priority
                    />
                  </motion.div>
                </motion.div>
